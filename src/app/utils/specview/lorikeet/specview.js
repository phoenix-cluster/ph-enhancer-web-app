...
(function($) {
	...
	function createPlot(container, datasets) {
        ...
        //to move the yaxis labels to o at x axis
        // var yaxis = plot.getAxes().yaxis;
        // $('.x1Axis .tickLabel').css('top',yaxis.p2c(0)+5+'px');
	...
	function initContainer(container) {
		...
		var parentTable = '<table cellpadding="0" cellspacing="100" class="lorikeet-outer-table" style="width: 100%;"> ';
		parentTable += '<tbody> ';
		parentTable += '<tr> ';
